...
export default function Home() {
  ...
  return (
    <main className="flex-1 flex flex-col md:flex-row items-center relative">
      ...
      <Image className="absolute right-0 top-2/3" src={`/einst1.png`} alt="logo" width={120} height={188} />
